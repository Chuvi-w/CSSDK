...
void CXM1014::PrimaryAttack(void)
{
	...
	m_pPlayer->FireBullets(6, m_pPlayer->GetGunPosition(), gpGlobals->v_forward, VECTOR_CONE_XM1014, 3048, BULLET_PLAYER_BUCKSHOT, 0);
	...
	PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), m_usFireXM1014, 0, (float*)&g_vecZero, (float*)&g_vecZero,
		m_vVecAiming.x, m_vVecAiming.y, 7, m_vVecAiming.x * 100, m_iClip != 0, FALSE);
