...
void CMAC10::MAC10Fire(float flSpread, float flCycleTime, BOOL fUseAutoAim)
{
	...
	Vector vecDir = m_pPlayer->FireBullets3(m_pPlayer->GetGunPosition(), gpGlobals->v_forward, flSpread,
		MAC10_DISTANCE, MAC10_PENETRATION, BULLET_PLAYER_45ACP, MAC10_DAMAGE, MAC10_RANGE_MODIFER, m_pPlayer->pev, FALSE, m_pPlayer->random_seed);
	...
	PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), m_usFireMAC10, 0, (float*)&g_vecZero, (float*)&g_vecZero, vecDir.x, vecDir.y,
